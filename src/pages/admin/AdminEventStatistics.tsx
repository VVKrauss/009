...
export default EventsStatistics;24 bg-gradient-to-br from-primary-100 to-primary-200 dark:from-primary-900/20 dark:to-primary-800/20 rounded-full flex items-center justify-center mx-auto mb-6">
          ...
          {activeTab === 'past' && (
            <div>
              ...
              {loading.past ? (
                ...
                <div className="text-center py-16">
                  <div className="w-24 h-import React, { useState, useEffect } from 'react';
