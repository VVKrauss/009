...
type AboutSectionEditorProps = {
  ...
  onUpdate: (data: AboutSectionData) => void;
};

const AboutSectionEditor = ({ siteSettingsId, initialData, onUpdate }: AboutSectionEditorProps) => {
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-medium">Настройки блока "О нас"</h3>
