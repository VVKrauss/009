/*
  # Add functions for website analytics
  
  1. New Functions
    - `get_detailed_page_stats`: Gets detailed page statistics including title, unique visitors, and bounce rate
    - `get_traffic_by_hour`: Gets traffic distribution by hour of day
    - `get_traffic_by_day`: Gets traffic distribution by day of week
    
  2. Purpose
    - Support comprehensive website analytics dashboard
    - Enable detailed page performance analysis
    - Provide traffic pattern insights
*/
...
BEGIN
  ...
  SELECT
    ...
    ROUND(
      ...
      ) = 1 THEN 1 ELSE NULL END)::NUMERIC / COUNT(*)::NUMERIC * 100
    ), 1) as bounce_rate,
